...
const myDog = new DogCl();
myDog.makeSound(); // Outputs: Woof!
myDog.move(); // Outputs: Dog is moving.
 ...
 * Abstract Methods:
   The `makeSound` method is abstract and must be implemented in any concrete subclass like `DogCl`.

 * Concrete Methods:
   Methods like `move` provide common functionality that all subclasses can use.
 */
