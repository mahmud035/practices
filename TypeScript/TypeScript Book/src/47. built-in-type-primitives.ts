...
// NOTE: TypeScript has several built-in type primitives that can be used to define variables, function parameters, and return types:
...
console.log('Built-in Type Primitives');
