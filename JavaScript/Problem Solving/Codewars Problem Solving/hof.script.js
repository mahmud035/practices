...
//* My Solution
{
  ...
  Primary Sort (by language): The array is sorted by the language property using localeCompare, which compares two strings in a locale-aware manner.
  
  Secondary Sort (by first name): If the languages are the same (a.language === b.language), the firstName properties are compared and used for sorting. 
  */
}
